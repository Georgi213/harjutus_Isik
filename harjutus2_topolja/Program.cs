...
Tootaja tootaja = new Tootaja("tootaja", "TTHK", "õpetaja", "Vladimir", 1989, Isik.sugu.Mees, 500, 1100, 20);
tootaja.print_Info();
Opilane opilane = new Opilane("opilane", "TTHK", "TARPV20", "õpilane", "Georgi", 2003, Isik.sugu.Mees, 0, 0, 0);
opilane.print_Info();
Kutsekooliopilane kutsekooliopilane = new Kutsekooliopilane("kutsekooliopilane", 60, "Tallinn", 450, 3, 4.5, "THK", "tarkvara arendaja", "TARPV20", "Aleksei", 2004, Isik.sugu.Mees, 0, 0, 0);
